...
class Train:
    ...
    def _init_(self, ID = 0, route = []):
        ...
        #signals.train_model_get_lights.connect(self.train_model_set_lights)
        #signals.train_model_get_doors.connect(self.train_model_set_doors)
        #signals.train_model_get_announcement.connect(self.train_model_get_announcement)
        #signals.train_model_get_ads.connect(self.train_model_get_ads)
        #signals.train_model_get_temp(self.train_model_get_temp)
        #signals.train_model_get_service_brake(self.train_model_get_service_brake)
        #signals.train_model_get_emergency_brake(self.train_model_get_emergency_brake)
        #signals.train_model_get_passenger_ebrake(self.train_model_passenger_ebrake)
        #signals.train_model_get_power(self.train_model_get_power)
        #signals.train_model_set_grade(self.train_model_set_grade)
        ...
        #signals.train_model_set_brake_failure(self.set_brake_failure)
        #signals.train_model_set_engine_falure(self.set_engine_failure)
        #signals.train_model_set_signal_pickup_failure(self.sete_signal_pickup_failure)
        #signals.train_model_fix_failure(self.train_model_fix_failure)
        #signals.train_model_get_circuit(self.train_model_get_circuit)
        #signals.train_model_get_horn(self.train_model_get_horn)
...
# ---------------------------------------------------------------------------------------------
    ...
    #sets train lights
    def train_model_set_lights(self, interior, exterior):
        if(interior == True):
    ...
    def train_model_get_emergency_brake(self, emergency_brake):
        self.ebrake = emergency_brake
        #signals.train_model_update.emit()

    def train_model_get_beacon_info(self, beacon):
...
# ---------------------------------------------------------------------------------------------
    ...
    #set grade
    def train_model_set_grade(self, new_grade):
    ...
    #sets beacon info
    def train_model_set_beacon(self, door_side, station):
...
# ---------------------------------------------------------------------------------------------
    ...
    #murphy sets failure
    def train_model_set_brake_failure(self, fail):
        self.brake_failure = fail
        #signals.train_model_update.emit()

    #murphy sets failure
    def train_model_set_engine_failure(self, fail):
        self.engine_failure = fail
        #signals.train_model_update.emit()

    #murphy sets failure
    def train_model_set_signal_pickup_failure(self, fail):
...
# ---------------------------------------------------------------------------------------------
    ...
    def train_model_get_power(self, new_power):
