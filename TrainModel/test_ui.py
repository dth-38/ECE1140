...
class test_Ui(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton.setGeometry(QtCore.QRect(70, 20, 221, 91))
        ...
        self.pushButton.pressed.connect(self.test_power)

    def test_power(self):
        mitter = float(self.power_line.text())
        signals.test_power.emit(mitter)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.train_id_label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:36pt;\">TestUi</span></p></body></html>"))
