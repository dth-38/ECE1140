...
class NSE_Simulation(QMainWindow):
    ...
    def __init__(self, run=False):
        ...
        #create the Track model singleton
        a_model = TrackModel()

        #create the CTC singleton
        clk = CTC_Clock()
        sch = CTC_Scheduler()
        self.ctc_office = CTC(clk, sch, a_model)
        self.ctc_office.add_ui(self.ctc_office)
...
#-------------------------------------------------------------
    def setup_GUI(self):
        ...
        self.ctc_button.clicked.connect(self.open_ctc) #also make sure to pass in ctc
